...
export interface WalletPortabilityJobRecord {
  ...
  // SHA-256 checksum -- always computed over whatever bytes were actually uploaded (see
  // gzipAndChecksum/checksumFile). s3Key is the persisted, stable reference; downloadUrl (below) is NOT
